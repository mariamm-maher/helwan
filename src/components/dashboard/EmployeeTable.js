...
import { fetchDataForEmployees } from "../../Services/AdminServices";
...
function EmployeesTable() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["EmployeestableData", pageIndex, pageSize],
    queryFn: () => fetchDataForEmployees({ pageIndex, pageSize }),
